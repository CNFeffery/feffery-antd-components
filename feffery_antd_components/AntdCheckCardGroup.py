...
- persistence_type (a value equal to: 'local', 'session', 'memory'; optional):
    ...
    def __init__(
        ...
        defaultValue: typing.Optional[typing.Union[typing.Union[NumberType, str], typing.Sequence[typing.Union[NumberType, str]]]] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'key', 'children', 'style', 'className', 'name', 'enableBatchControl', 'multiple', 'allowNoValue', 'bordered', 'value', 'defaultValue', 'disabled', 'size', 'readOnly', 'data-*', 'aria-*', 'persistence', 'persisted_props', 'persistence_type']
        self._valid_wildcard_attributes =            ['data-', 'aria-']
        self.available_properties = ['id', 'key', 'children', 'style', 'className', 'name', 'enableBatchControl', 'multiple', 'allowNoValue', 'bordered', 'value', 'defaultValue', 'disabled', 'size', 'readOnly', 'data-*', 'aria-*', 'persistence', 'persisted_props', 'persistence_type']
