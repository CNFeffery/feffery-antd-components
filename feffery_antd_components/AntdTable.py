...
- expandedRowContents (list of a list of or a singular dash component, string or numbers; optional)

- expandedRowContentsKeys (list of string | numbers; optional)

- expandedRowFixed (boolean | a value equal to: 'left', 'right'; optional)

- expandedRowIndentSize (number; optional)
