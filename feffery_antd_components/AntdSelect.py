...
- persistence_type (a value equal to: 'local', 'session', 'memory'; optional):
    ...
    默认值：`'local'`."""
    _children_props: typing.List[str] = ['options[].label', 'options[].group', 'options[].options[].label', 'emptyContent', 'loadingEmptyContent', 'dropdownBefore', 'dropdownAfter', 'prefix', 'suffixIcon']
