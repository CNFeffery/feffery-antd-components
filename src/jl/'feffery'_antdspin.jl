...
- `listenPropsMode` (String; optional)
...
function 'feffery'_antdspin(; kwargs...)
        available_props = Symbol[:children, :id, :className, :debug, :delay, :excludeProps, :includeProps, :listenPropsMode, :loading_state, :size, :spinning, :style, :text]
        wild_props = Symbol[]
