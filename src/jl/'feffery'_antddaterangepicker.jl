...
function 'feffery'_antddaterangepicker(; kwargs...)
        available_props = Symbol[:id, :bordered, :className, :defaultPickerValue, :disabledEnd, :disabledStart, :loading_state, :picker, :placeholderEnd, :placeholderStart, :selectedEndDate, :selectedStartDate, :showTime, :size, :style]
        wild_props = Symbol[]
